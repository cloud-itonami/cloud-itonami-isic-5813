(ns pressops.phase
  "Phase 0->3 staged rollout for the ISIC-5813 newspaper/journal/
  periodical-publishing operations-coordination actor.
  ...
  needs a human to actually look at it. `pressops.governor`'s own
  `always-escalate-ops` enforces the same invariant independently --
  two layers, not one, agree on this."
  (:require [pressops.governor :as governor]))
...
(defn verdict->disposition
  "Map a PressGovernor verdict to a base disposition before
  the phase gate."
  [verdict]
