# Operator Quickstart — Publishing of newspapers, journals and periodicals

Shortest path from clone to a verified local dry-run for **ISIC 5813** (`cloud-itonami-isic-5813`).
...
```bash
git clone https://github.com/cloud-itonami/cloud-itonami-isic-5813.git
cd cloud-itonami-isic-5813
```
...
- Blueprint governor key: `pressops-governor`
- Likely source path: `pressops.governor.cljc`
